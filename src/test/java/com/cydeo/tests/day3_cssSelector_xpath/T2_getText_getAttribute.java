...
public class T2_getText_getAttribute {
    public static void main(String[] args) {
       ...
       // 3- Verify “remember me” label text is as expected:
        ...
        String actualRememberMeLabel=remeberMeLabel.getText();
       ...
       // Expected: Forgot your password?
        ...
        String actualForgotLinkText=forgotPasswordLink.getText();
        if(actualForgotLinkText.equals(expectedForgotLinkText)){
